...
model = Sequential()
#wenn Ihr auf die output von encoder und decoder zugreifen möchtet
# outputencoder
outputencoder = encoder(input_layer,code_size)
#outputdecoder
outputdecoder  = decoder(encoder(input_layer,code_size))
